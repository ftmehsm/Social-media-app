...
export default function NewChatDialog({
  ...
  const { data, isFetching, isError, isSuccess } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Filter out logged-in user and admins in JavaScript
  ...
  const mutation = useMutation({
    mutationFn: async () => {
      // Ensure all users exist in Stream Chat before creating channel
      const allUserIds = [loggedInUser.id, ...selectedUsers.map((u) => u.id)];
      ...
      // Create the channel - this will automatically add members if they exist
      await channel.create();

      // Wait a bit for channel to be fully initialized
      await channel.watch();
